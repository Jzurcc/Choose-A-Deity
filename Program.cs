...
███   ███ ███    ███ ███    ███        ███    ███     ███    ███ ███    ███   ███    ███      ███   ▄███ ███    ███    ███ ███   ▄███ 
 ▀█████▀   ▀██████▀  ████████▀         ███    █▀      ███    █▀   ▀██████▀    ██████████      ████████▀  █▀     ██████████ ████████▀  
    ...
    public void Annhilation(dynamic enemy) {
        ...
        DMG = GetDMG(Math.Clamp(ATK*0.5+ATK*0.1*(Math.Max(1, TotalKills)), 0, ATK*3), enemy);
        if (CheckEvade(DMG, enemy))
...
public class RoomGenerator {
    ...
    public RoomGenerator() {
        ...
        public void InitializeRoom() {
            ...
            InitializeItems(NextInt(10+player.Stage, 20+player.Stage), NextInt(5+player.Stage, 10+player.Stage));
            ...
            switch(player.Deity) {
                ...
                case DeityEnum.End:
                    ...
                    [
                        ...
                        $"Void Slash\n     Damage: {player.ATK*0.9:0} DMG 1-4 times\n", 
                        $"Shrouded Mist\n     Effect: +3 SPD & +3 LCK\n", 
